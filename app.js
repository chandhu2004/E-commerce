...
connectDB().then(() => {
    ...
    // Protected products page (after login)
    ...
    // Auth routes
    app.get('/login', (req, res) => {
        res.render('login', { layout: 'main', cssFile: ['animation.css', 'form.css'] });
    });

    app.get('/register', (req, res) => {
        res.render('register', { layout: 'main', cssFile: 'animation.css' });
    });
    ...
    // Product list (public route just for testing)
